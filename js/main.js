...
var tableauProduct = [];
var i =0;
var envoie, envoie2, envoie3, envoie4;
...
function form (titre,phrase,description) {
  ...
  // new Produit et mettre dand tableauProduct
    ...
    envoie = $('<p class="lol" ></p>').text(tableauProduct[i].titre);
    envoie2 = $('<p class="lol" ></p>').text(tableauProduct[i].phrase);
    envoie3 = $('<p class="lol" ></p>').text(tableauProduct[i].description);
    envoie4 = $('<p class="test" ></p>').text(" ");
    test();
    reset();
    i++;
  }
...
$.getJSON('test.json',function(data){
           ...
           $.each(data,function(index,d){
             ...
             $('#demo').append('Prénom : ' + d.Prenom + '<br>');

             $('#demo').append('Nom : ' + d.Nom + '<br>');

             $('#demo').append('Age : ' + d.Age + '<br><br>');
